...
public class OP4_CorreccionEvaluacionService {
    ...
    /**
     * Ejecuta la corrección del siguiente trabajo en la cola.
     *
     * @param request datos de la corrección (cursoId, puntaje, comentario, instructorId)
     * @return CorreccionResponse con el resultado completo
    ...
    /**
     * Parsea el JSON de la entrega para extraer el campo "alumno_id".
     * Si el JSON es inválido o no tiene ese campo, usa "desconocido".
     */
